...
struct FontStandardOrangeTheme: FontThemeProtocol {
    var Regular: String { return FontStyle.Regular.rawValue }
    
    var Bold: String { return FontStyle.Bold.rawValue }
    
    var TextColour: UIColor { return UIColor.OrangeColourPalette.darkOrange }
