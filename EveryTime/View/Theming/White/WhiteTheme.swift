...
struct WhiteTheme: ThemeProtocol {
    ...
    static var productIdentifier: String = "com.whizbang.Everytime.whitetheme"
    
    static var resource: String = "whitetheme"
    ...
    var generalBackgroundColour: UIColor = UIColor.WhiteColourPalette.white
    ...
    func updateNavView() {
        ...
        UILabel.appearance(whenContainedInInstancesOf: [NavView.self]).textColor = NavigationStandardWhiteTheme.textColour
