...
class TableViewStandardWhiteTheme: TableViewThemeProtocol {
    ...
    var cellTextColor: UIColor = UIColor.WhiteColourPalette.white
    ...
    var settingsCell: [NSAttributedString.Key : Any] = [NSAttributedString.Key.font: UIFont(name: FontStandardWhiteTheme.FontStyle.Bold.rawValue, size: FontStandardWhiteTheme.FontSize.Standard(.b2).value)!, NSAttributedString.Key.foregroundColor: NavigationStandardLightTheme.textColour, NSAttributedString.Key.kern: FontStandardWhiteTheme.FontKern.General.floatValue]
