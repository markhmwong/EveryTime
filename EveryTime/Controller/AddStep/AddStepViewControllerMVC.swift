...
//}
//
//class AddStepViewControllerMVC: ViewControllerBase, UITextFieldDelegate {
//
...
//        //goes into view model first
//
//        addStepViewModel = AddStepViewModel(addStep: StepEntity(name: name, hours: hrs, minutes: min, seconds: sec, priority: Int16(0)))
//
